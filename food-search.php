    ...
    <section class="food-menu">
        <div class="container">
            ...
            <?php 
                ...
                $sql = "SELECT * FROM movies WHERE title LIKE '%$search%' OR description LIKE '%$search%'";
                            ...
                            <div class="food-menu-img">
                                <?php 
                                    ...
                                    else
                                    {
                                        //Image Available
                                        ?>
                                        <img src="<?php echo SITEURL; ?>images/movies/<?php echo $image_name; ?>" alt="Chicke Hawain Pizza" class="img-responsive1 img-curve1"height="130px">
                                        <?php 
